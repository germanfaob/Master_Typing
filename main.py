...
# We need the start button&countdown to run at the same time
def start():
...
# Root window
root=Tk()
root.geometry('945x735+400+100')
root.config(bg=deepGrey)
root.resizable(False,False)
root.overrideredirect(True)

mainframe=Frame(root,bd=4, bg=deepGrey)
mainframe.grid()

titleframe=Frame(mainframe,bg=deepGrey)
titleframe.grid()

titleLabel=Label(titleframe,text='Master Typing',font=('Courier',30,'bold'),bg=deepGrey,fg=orange
                 ,width=38,bd=10)
titleLabel.grid(pady=5)

paragraph_frame=Frame(mainframe, bg=deepGrey)
...
label_paragraph=Label(paragraph_frame,text=paragraph_list[0],wraplength=912,justify=CENTER,font=('Helvetica',13,'bold'), bg=deepGrey, foreground='white')
label_paragraph.grid(row=0,column=0)

textarea_frame=Frame(mainframe)
textarea_frame.grid(row=2,column=0)

textarea=Text(textarea_frame,font=('Helvetica',13,'bold'), bg=grey, foreground='white', width=100,height=7,bd=4,relief=GROOVE,wrap='word'
              ,state=DISABLED)
textarea.grid()

###List of buttons and labels

# Statistics labels
frame_output=Frame(mainframe, bg=deepGrey)
frame_output.grid(row=3,column=0)

elapsed_time_label=Label(frame_output,text='Elapsed Time',font=('Courier',12,'bold'),fg=orange, bg=deepGrey)
elapsed_time_label.grid(row=0,column=0,padx=5)

elapsed_timer_label=Label(frame_output,text='0',font=('Courier',12,'bold'), bg=deepGrey, foreground='white')
elapsed_timer_label.grid(row=0,column=1,padx=5)

remaining_time_label=Label(frame_output,text='Remaining Time',font=('Courier',12,'bold'),fg=orange, bg=deepGrey)
remaining_time_label.grid(row=0,column=2,padx=5)

remaining_timer_label=Label(frame_output,text='60',font=('Courier',12,'bold'), bg=deepGrey, foreground='white')
remaining_timer_label.grid(row=0,column=3,padx=5)

wpm_label=Label(frame_output,text='WPM',font=('Courier',12,'bold'),fg=orange, bg=deepGrey)
wpm_label.grid(row=0,column=4,padx=5)

wpm_count_label=Label(frame_output,text='0',font=('Courier',12,'bold'), bg=deepGrey, foreground='white')
wpm_count_label.grid(row=0,column=5,padx=5)

totalwords_label=Label(frame_output,text='Total Words',font=('Courier',12,'bold'),fg=orange, bg=deepGrey)
totalwords_label.grid(row=0,column=6,padx=5)

totalwords_count_label=Label(frame_output,text='0',font=('Courier',12,'bold'), bg=deepGrey, foreground='white')
totalwords_count_label.grid(row=0,column=7,padx=5)

wrongwords_label=Label(frame_output,text='Wrong Words',font=('Courier',12,'bold'),fg=orange, bg=deepGrey)
wrongwords_label.grid(row=0,column=8,padx=5)

wrongwords_count_label=Label(frame_output,text='0',font=('Courier',12,'bold'), bg=deepGrey, foreground='white')
wrongwords_count_label.grid(row=0,column=9,padx=5)

accuracy_label=Label(frame_output,text='Accuracy',font=('Courier',12,'bold'),fg=orange, bg=deepGrey)
accuracy_label.grid(row=0,column=10,padx=5)

accuracy_percent_label=Label(frame_output,text='0',font=('Courier',12,'bold'), bg=deepGrey, foreground='white')
accuracy_percent_label.grid(row=0,column=11,padx=5)

# Interaction buttons
buttons_Frame=Frame(mainframe, bg=deepGrey)
buttons_Frame.grid(row=4,column=0)

style = ttk.Style()
style.configure('TButton', background=orange, width=15)
style.map('TButton', background=[('active',deepGrey)])
...
# Keyboard labels
keyboard_frame=Frame(mainframe, bg=deepGrey)
keyboard_frame.grid(row=5,column=0)

frame1to0=Frame(keyboard_frame, bg=deepGrey)
frame1to0.grid(row=0,column=0,pady=3)

label1=Label(frame1to0,text='1',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
label2=Label(frame1to0,text='2',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
label3=Label(frame1to0,text='3',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
label4=Label(frame1to0,text='4',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
label5=Label(frame1to0,text='5',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
label6=Label(frame1to0,text='6',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
label7=Label(frame1to0,text='7',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
label8=Label(frame1to0,text='8',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
label9=Label(frame1to0,text='9',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
label0=Label(frame1to0,text='0',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
...
frameqtop=Frame(keyboard_frame, bg=deepGrey)
frameqtop.grid(row=1,column=0,pady=3)
labelQ=Label(frameqtop,text='Q',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelW=Label(frameqtop,text='W',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelE=Label(frameqtop,text='E',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelR=Label(frameqtop,text='R',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelT=Label(frameqtop,text='T',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelY=Label(frameqtop,text='Y',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelU=Label(frameqtop,text='U',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelI=Label(frameqtop,text='I',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelO=Label(frameqtop,text='O',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelP=Label(frameqtop,text='P',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
...
frameatol=Frame(keyboard_frame, bg=deepGrey)
frameatol.grid(row=2,column=0,pady=3)
labelA=Label(frameatol,text='A',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelS=Label(frameatol,text='S',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelD=Label(frameatol,text='D',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelF=Label(frameatol,text='F',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelG=Label(frameatol,text='G',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelH=Label(frameatol,text='H',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelJ=Label(frameatol,text='J',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelK=Label(frameatol,text='K',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelL=Label(frameatol,text='L',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
...
frameztom=Frame(keyboard_frame, bg=deepGrey)
frameztom.grid(row=3,column=0,pady=3)
labelZ=Label(frameztom,text='Z',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelX=Label(frameztom,text='X',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelC=Label(frameztom,text='C',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelV=Label(frameztom,text='V',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelB=Label(frameztom,text='B',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelN=Label(frameztom,text='N',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
labelM=Label(frameztom,text='M',bg='black',fg='white',font=('Helvetica',10,'bold'),width=5,height=2,bd=3,relief=RAISED)
...
labelSpace=Label(spaceFrame,bg='black',fg='white',font=('Helvetica',10,'bold'),width=40,height=2,bd=3,relief=RAISED)
labelSpace.grid(row=0,column=0)


# Color effect when keyboard is pressed
def changeBG(widget):
